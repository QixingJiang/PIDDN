...
def build_dataset(cfg, default_args=None):
    ...
    Args:
        cfg:<class 'mmcv.utils.config.ConfigDict'>
for example {
            'type': 'TestCocoDataset', \
            'ann_file': 'data/coco2017_test/annotations/train_2017.json', \
            'img_prefix': 'data/coco2017_test/train2017/', \
            'pipeline': [{'type': 'LoadImageFromFile'}, \
            {'type': 'LoadAnnotations', 'with_bbox': True}, \
            {'type': 'Resize', 'img_scale': (1333, 800), 'keep_ratio': True}, \
            {'type': 'RandomFlip', 'flip_ratio': 0.5}, \
            {'type': 'Normalize', 'mean': [102.9801, 115.9465, 122.7717], \
            'std': [1.0, 1.0, 1.0], 'to_rgb': False}, {'type': 'Pad', 'size_divisor': 32},\
    ...
    Returns:
        dataset： <class 'mmdet.datasets.mytestcoco.TestCocoDataset'>
...
def build_dataloader(dataset,
    ...
    # build the dataloader from PyTorch
