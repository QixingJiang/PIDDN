...
class PairPcbDataset(CustomDataset):
    ...
    def __init__(self,
        ...
        # below code first init the <class 'mmdet.datasets.pipelines.compose.Compose'> type data
        # i.e., build the Class Compose; and then , secondly, call the function, i.e., the __call__ of Class Compose
