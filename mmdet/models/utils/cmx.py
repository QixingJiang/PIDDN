...
class FeatureFusionModule(nn.Module):
    def __init__(self, dim, reduction=1, num_heads=None, norm_layer=nn.BatchNorm2d):
        ...
        self.channel_emb = ChannelEmbed(in_channels=dim * 2, out_channels=dim * 2, reduction=reduction,
...
if __name__ == "__main__":
    ...
    # print(output2.shape)
    # 2、FFM
    fuse = FeatureFusionModule(dim=96,num_heads=3, norm_layer=nn.BatchNorm2d)
    output3 = fuse(output1, output2)
