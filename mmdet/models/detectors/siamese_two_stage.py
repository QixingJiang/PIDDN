...
class SiameseTwoStageDetector(SiameseBaseDetector):
    """Base class for siamese-two-stage detectors.
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(SiameseTwoStageDetector, self).__init__(init_cfg)
        if pretrained:
    ...
    def forward_train(self,
        ...
        """
        super(SiameseTwoStageDetector, self).forward_train(img, img_metas)
        x = self.extract_feat(img)
        if len(img_metas) == 2:
