...
model = dict(
    ...
    backbone_post=dict(type='BackbonePostSpatialAttention',num_feats=4),
    neck_post=None,
    neck=dict(
        type='FPN',
...
work_dir = './pretrained_work_dir/htc_mulframe_swin_t_fpn_192_backbone_post_cbam_spatial_new/'
auto_resume = False
gpu_ids = [0]
