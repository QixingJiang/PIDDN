...
train_pipeline = dict(
    list_of_pipeline=[[{'type': 'LoadImageFromFile'},
        {'type': 'LoadAnnotations','with_bbox': True},
        {'type': 'Resize','img_scale': (256, 256),'keep_ratio': True},
                       {'type': 'SeedRandomFlip','flip_ratio': 0.5,'seed': 287828162},
                       {
        'type': 'Normalize',
...
work_dir = './new_anno_workdir/htc_mulframe_swin-t_bp_ffm_concat_CA_maxpool'
auto_resume = False
gpu_ids = [0]
