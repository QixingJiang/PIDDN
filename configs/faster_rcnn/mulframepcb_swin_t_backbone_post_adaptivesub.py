...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=
        '/docker_host/data/project_dataset/PCB_complete/annotations/instances_val2017.json',
...
evaluation = dict(interval=1, metric='mAP', iou_thr=0.5, save_best='mAP')
...
work_dir = './pretrained_work_dir/faster_rcnn_mulframe_swin_t_backbone_post_adaptivesub/'
auto_resume = False
gpu_ids = [0]
