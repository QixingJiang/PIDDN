# model settings
pretrain_swin_tiny='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_tiny_patch4_window7_224.pth'
model = dict(
    type='CascadeRCNN',
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',checkpoint=pretrain_swin_tiny)),
    neck=dict(
        type='FPN',
...
work_dir = './new_anno_workdir/cascade_swin-t_single_baseline_randomflip/'
auto_resume = False
gpu_ids = [0]
