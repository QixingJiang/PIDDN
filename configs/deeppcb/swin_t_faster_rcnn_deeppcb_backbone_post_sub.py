...
model = dict(
    ...
    backbone_post=dict(type='BackbonePostSubtraction', style='subtraction',adaptive=False),
    neck_post=None,
    neck=dict(
        type='FPN',
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=100,
            mask_thr_binary=0.5)))
dataset_type = 'MulFrameDeepPCBDataset'
...
evaluation = dict(interval=10, metric='mAP', iou_thr=0.5, save_best='mAP')
