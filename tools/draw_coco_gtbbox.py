...
if __name__ == "__main__":
    ...
    img_dir =  '/docker_host/data/project_dataset/PCB_complete/images'
    ann_file = '/docker_host/data/project_dataset/PCB_complete/annotations/instances_val2017_modify.json'
    save_dir = '/docker_host/data/project_dataset/PCB_complete/val_with_gt'
    category = ['块', '点', '线']
    ...
    for idx, group in tqdm(enumerate(all_images)):
        ...
        new_img = drawBbox(img_array, ann_needed)
